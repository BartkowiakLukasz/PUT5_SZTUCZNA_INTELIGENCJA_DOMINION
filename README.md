...
Projekt sztucznej inteligencji do gry planszowej **Dominion** [https://jpneto.github.io/world_abstract_games/dominion](https://jpneto.github.io/world_abstract_games/dominion.htm). (abstrakcyjna gra strategiczna). Bot został zoptymalizowany pod kątem szybkiego przeszukiwania drzewa gry oraz zaawansowanej oceny sytuacji na planszy, a jego parametry zostały wyuczone za pomocą algorytmu genetycznego.
